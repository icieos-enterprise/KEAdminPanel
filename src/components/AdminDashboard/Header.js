  ...
  return (
    <header className="bg-[#161616] h-20 flex justify-between items-center px-4 md:px-6 ">
      ...
      <div className="flex items-center">
        ...
        <div
          className="bg-[#1F1F1F] h-[46px] w-[200px] sm:w-[240px] md:w-[280px] rounded-full flex items-center justify-between px-2 sm:px-4 relative">
          ...
          {isOpen && (
            <div
              className="absolute right-0 top-12 w-40 sm:w-48 bg-[#454444] divide-y divide-gray-600 rounded-md shadow-lg mr-10 md:mr-20">
              <a href="" className="flex items-center px-4 py-2 text-sm text-white hover:bg-gray-700 gap-2">
          ...
          {/* User Info */}
          <span
            className="text-white text-xs sm:text-sm font-semibold truncate max-w-[100px] sm:max-w-[120px] md:max-w-[140px] mr-1 md:mr-9">
            {userName}
          </span>
          <img
            src={Avatar}
